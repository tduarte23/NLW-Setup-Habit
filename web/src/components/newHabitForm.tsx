    ...
    return(
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
            ...
            <div className="flex flex-col gap-2 mt-3">
                ...
                >
                    <div className='group-data-[state=checked]:bg-green-500 group-data-[state=checked]:border-green-500 h-8 w-8 rouunded-lg flex items-center justify-center bg-zinc-900 border-zinc-800'>
                        <Checkbox.Indicator>
